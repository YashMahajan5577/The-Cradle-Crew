        ...
        <div className="w-full h-fit bg-white rounded-xl border p-5 flex justify-between ">
          ...
          <div className="flex flex-col justify-between items-center">
            <div className="flex flex-col items-center">
              ...
              <button
                onClick={() => {
                  window.localStorage.setItem("update", "CRECHE");
                  navigate("/reg/creche");
                }}
            ...
            <a
              ...
              href="https://gentle-bayou-69601.herokuapp.com/24c0ded0-7e17-4044-9e38-b6bc1bce725e"
              target={"_blank"}
            >
              Stream CCTV
            </a>
    ...
    return (
      <div>
        <Dialog open={props.open.open} onClose={handleClose}>
          ...
          <DialogContent>
            <DialogContentText>
              Please confirm that you want to accept this request and share the
              conference link with{" "}
            ...
            <Button
              onClick={() => {
                ...
                Api.acceptAppointment(
                  parentUsername,
                  "https://gentle-bayou-69601.herokuapp.com/24c0ded0-7e17-4044-9e38-b6bc1bce725e",
                  (response) => {
                    if (response.data.auth) {
